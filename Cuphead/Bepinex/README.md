...
## ✨ Features
- Official BepInEx 5.4.23.5 x64 package, repacked for Cuphead
- Required by Cuphead Double Assist, Cuphead UltraWide and other BepInEx mods
- Extract and play, no extra setup

## 📦 Install
Download on [Nexus Mods](https://www.nexusmods.com/cuphead/mods/173). Extract into the game folder and play.

## 🔗 Links
- Mod page: https://www.nexusmods.com/cuphead/mods/173
